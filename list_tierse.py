...
for race in tierce_list:
    print(f"{race['day']} {race['location']} {race['race_no']:>2}R {race['horse_cnt']:>2}頭 {','.join([str(n) for n in race['ninki']]):8} {' '.join([f'{yen:,}円' for hn, yen in race['tierce_yen'].items()])} {race['race_title']} {race['grade']}")
