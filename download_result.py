...
for race_url in race_list:
    ...
    (race_name, race_title, grade, rank_list, win_yen, place_yen_list, umaren_yen, umatan_yen, wide_yen_list, trio_yen, tierce_yen, tierce_ninki) = keiba_lib.get_rank_list(html)
